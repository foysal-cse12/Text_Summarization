...
if (arg!=3):
    ...
    sys.exit('Usage: python T5_baseline.py training_csv_file validation_csv_file')
tr_file = sys.argv[1]
val_file = sys.argv[2]
...
training_args = TrainingArguments(
    ...
    save_steps=1000,  # set to 500 for full training #16
    eval_steps=1000,  # set to 8000 for full training #4
